...
Server is like a computer they have local + CPU + RAM which is imp to run an application or process.
...
You don’t buy servers → you rent servers from companies like Amazon Web Services, Microsoft Azure, Google Cloud Platform
...
Cloud computing = using cloud resources (servers, storage, databases, networking, software) via the internet to run applications.
